                    ...
                    <div class="row h-100vh vertical-center">
                        <div class="col-sm-12 upload-responsive">
                            <div class="text-container text-center">
                                ...
                                <h1 data-aos="fade-up" data-aos-delay="100" data-aos-once="true" data-aos-duration="200">{{ __('Advanced AI Platform') }}</span></h1>
                                ...
                                <a href="{{ route('register') }}" class="btn-primary-frontend btn-frontend-scroll-effect mb-2" id="top-main-button"  data-aos="fade-up" data-aos-delay="500" data-aos-once="true" data-aos-duration="800">
                                    <div>
                                        <span>{{ __('Enter BlockEngine') }}</span>
                                        <span>{{ __('Enter BlockEngine') }}</span>
                                    </div>
                                </a>
                                <div>
                                    <span class="fs-12" data-aos="fade-up" data-aos-delay="900" data-aos-once="true" data-aos-duration="1300">{{ __('Holders of $BLOCK get access for free! CA: 0x226d6d842D49b4D757bEf1632053a198D5D9c8aA') }}</span>
                                </div>
